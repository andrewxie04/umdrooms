...
//
// The building detail takes over the whole panel — the header /
// search / tabs / filter chrome would otherwise eat most of the panel height
...
export function BrowsePanel() {
  ...
  // Give selected buildings the full panel at every screen size.
  if (showDetail && loading.status !== 'error') {
    return (
    ...
    <div className="flex min-h-0 flex-1 flex-col">
      ...
      {loading.status === 'error' ? (
        <div className="flex min-h-0 flex-1 flex-col items-center justify-center px-6 py-12 text-center">
          ...
          <p className="mt-4 text-base font-semibold tracking-tight text-foreground">Couldn’t load campus data</p>
